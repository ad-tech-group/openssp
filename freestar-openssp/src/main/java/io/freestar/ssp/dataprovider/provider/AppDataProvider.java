...
import io.freestar.ssp.dataprovider.provider.dto.AppDto;
...
public class AppDataProvider extends DataProvider {
    ...
    public AppDataProvider(HttpServer server) {
        super(server);
    }
    ...
    public void start() throws IOException {
        ...
        server.createContext("/ssp-data-provider/lookup/app", this);
    ...
    private void initData() throws IOException {
        ...
        data = gson.fromJson(content, AppDto.class);
    }

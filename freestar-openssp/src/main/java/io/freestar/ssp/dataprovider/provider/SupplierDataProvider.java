...
import io.freestar.ssp.dataprovider.provider.dto.SupplierDto;
...
public class SupplierDataProvider extends DataProvider {
    ...
    public void start() throws IOException {
        ...
        server.createContext("/ssp-data-provider/lookup/supplier", this);
    ...
    private void initData() throws IOException {
        ...
        data = gson.fromJson(content, SupplierDto.class);
    }
